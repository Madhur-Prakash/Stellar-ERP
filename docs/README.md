...
| **See the product without running it** | [Screenshots](screenshots.md) - eighteen shots, including the verifier passing **and** failing |
...
| [**Screenshots**](screenshots.md) | Eighteen shots at full size in three groups - the verifier (passing and failing), the product, and seven mobile viewports - each with what it shows and why that shot rather than another, plus the rules the set is held to. The root README carries four. |
