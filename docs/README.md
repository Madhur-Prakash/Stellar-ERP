...
| **Capture the screenshots** | [Screenshots](screenshots.md) - every shot, what it must show, and the capture rules |
| **See what it looks like first** | [Screenshots](screenshots.md), or open the [live verifier](https://stellar-erp-sigma.vercel.app/verify) - no account needed |
...
| [**Screenshots**](screenshots.md) | The interface at full size, shot by shot: what each capture has to have in frame and why that shot rather than another, plus the capture rules the set is held to. The root README carries the best four; this page carries all eight, plus the three still to capture and why each is the gap it is. |
