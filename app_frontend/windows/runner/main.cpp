...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  // 1440x900 rather than the 1280x720 default: the shell is a 248px sidebar plus a data
  // table, and the reports have five money columns. At 1280 the tables fit but the
